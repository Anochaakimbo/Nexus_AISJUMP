...
- **ตัวเลขเดียวกันต้องมาจากแหล่งเดียว** อย่าเก็บค่าซ้ำใน seed คนละไฟล์ ถ้าค่าหนึ่งคำนวณจากอีกค่าได้ ให้คำนวณ (ดู `overallSkillGap` ใน [src/data/careers.ts](src/data/careers.ts))
